...
const signup = () =>{
    ...
    return(
        <div style={{border:'1px solid purple',backgroundColor:'purple', padding:'10px',borderRadius:'10px',height:'520px',boxShadow:'5px 5px 10px white',width:'370px'}}>
            ...
            <button style={{width:'150px',height:'35px',fontSize:'x-large',borderRadius:'5px',color:'white',backgroundColor:'grey'}} onClick={signup}>Sign up</button>
            <p style={{fontSize:'large'}}>Already have an account?<span style={{cursor:'pointer'}} onClick={()=>navigate('/')}>Sign In</span></p>
